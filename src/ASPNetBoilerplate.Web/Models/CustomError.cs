...
namespace ASPNetBoilerplate.Web.Models
{
    /// <summary>
    ...
    public class CustomError
    {
        ...
        public CustomError(ErrorCode errorCode, Exception exception)
        {
            ...
            // If the following is not done, we get an empty JSON Array in the serialized JSON
            Data = errorCode != ErrorCode.InternalServerError && exception.Data.Keys.Count > 0 ? exception.Data : null;
        }
        ...
        /// </summary>
        /// <returns>
        /// A stringified value of an instance of <see cref="CustomError" /> class
        /// </returns>
